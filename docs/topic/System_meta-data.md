...
> [function]allfunctions()->Bag of Function f
...
> [function]allfunctions(Type t)->Bag of Function
...
> [function]allobjects(Type t)->Bag o
...
> [function]allsubtypes(Type t)->Type
...
> [function]allsupertypes(Type t)->Bag of Type
...
> [function]alltypes()->Bag of Type t
...
> [function]argument_types(Function f)->Vector of Type
...
> [function]arity(Function f)->Integer
...
> [function]attributes(Type t)->Bag of Function
...
> [function]calledby(Function f)->Bag of Function r
...
> [function]calledby_somehow(Function f)->Bag of Function
...
> [function]calls(Function f)->Bag of Function
...
> [function]calls_somehow(Function f)->Bag of Function g
...
> [function]cardinality(Type t)->Integer
...
> [function]deep_extent(Type tp)->Object



___

> [function]extent(Type t)->Object o
...
> [function]extent(Function f)->Bag of Vector
...
> [function]functionnamed(Charstring nm)->Function f
...
> [function]generic(Function r)->Function g
...
> [function]generic_name(Function f)->Charstring
...
> [function]kindoffunction(Function f)->Charstring
...
> [function]methods(Type t)->Function
...
> [function]name(Function f)->Charstring
...
> [function]name(Type t)->Charstring
...
> [function]resolvents(Function f)->Bag of Function
...
> [function]resolvents(Charstring fn)->Bag of Function
...
> [function]resolventtype(Function f)->Type
...
> [function]result_types(Function f)->Vector of Type
...
> [function]root_type(Type t)->Type
...
> [function]subtypes(Type t)->Bag of Type
...
> [function]supertypes(Type t)->Type
...
> [function]thefunction(Charstring fn)->Function
...
> [function]thefunctions(Vector of Charstring fns)->Vector of Function
...
> [function]theresolvent(Charstring fn)->Function
...
> [function]thetbr(Function f,Charstring bpat)->Function
...
> [function]thetype(Charstring tn)->Type
...
> [function]typenamed(Charstring nm)->Type t
...
> [function]typeof(Object o)->Type



___

> [function]typesof(Object)->Type
...
> [function]userfunction(Function f)->Boolean
...
> [function]userfunctions()->Bag of Function f
...
> [function]userobject(Object o)->Boolean
...
> [function]usersupertypes(Type t)->Bag of Type s
...
> [function]usertype(Type t)->Boolean
...
> [function]usertypes()->Bag of Type t
...
> [function]vref(Object o,Object i)->Object



___

> [function]width(Function f)->Integer
