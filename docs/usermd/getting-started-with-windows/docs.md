...
First you need to connect your Windows machine to the server. Follow the [Connecting an edge device](#/device_hub/getStarted) guide and come back here when your Windows machine is connected.
