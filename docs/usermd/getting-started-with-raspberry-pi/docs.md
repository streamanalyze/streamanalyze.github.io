...
First you need to connect the Raspberry Pi to the server. Follow the [Connecting an edge device](#/device_hub/getStarted) guide and come back here when the Raspberry Pi is connected.
